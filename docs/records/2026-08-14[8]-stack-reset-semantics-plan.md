...
> **Состояние документа**
>
> - **Тип:** план по принятой спеке `2026-08-14[7]`
> - **Статус:** готов к исполнению, реализация не начата
> - **Актуальность:** написан против `main` @ `ad53b97`
> - **Чему не верить:** числа полных ворот и CI здесь ожидаемые; новый handoff
>   записывает только фактически снятые результаты. Исходные и целевые байты
>   Task 1 сняты живым пробником 2026-08-14, но исполнитель всё равно повторяет
>   пробник перед красным тестом.
> - **Поправка рестарта 2026-08-14:** Task 4 резервировал архив `[9]`, но этот
>   номер занял handoff между планированием и реализацией. Во всех путях Task 4
>   читать `2026-08-14[9]-pre-h7-handoff.md` как
>   `2026-08-14[10]-pre-h7-handoff.md`; остальной план не меняется.
