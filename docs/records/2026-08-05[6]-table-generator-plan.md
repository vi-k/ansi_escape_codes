...
> **Состояние на 2026-08-16:** выполнен и влит в `main` мержем `fecaaf9`;
> верификация `2026-08-05[9]` подтвердила: восемь поверхностей покрыты,
> генератор идемпотентен, CI краснеет при ручной правке генерируемой зоны.
> В прозе старые пути: записи живут в `docs/records/`.
> **Что это:** план имплементации генератора таблиц цветов по дизайну
> `2026-08-05[5]`.
> **Связанные записи:** `2026-08-05[5]-table-generator-design.md`,
