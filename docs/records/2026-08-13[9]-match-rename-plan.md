...
> **Состояние документа**
>
> - **Тип:** план волны H9, 2026-08-13
> - **Статус:** согласован, реализация впереди
> - **Актуальность:** числа и ожидания сняты пробником на ветке
>   `fix/match-rename` @ `4788276`; спека — `2026-08-13[8]`
