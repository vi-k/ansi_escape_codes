...
> **Состояние на 2026-08-16:** исполнен и влит в `main` мержем `206a937`.
> Пункт B реализован в исправленном виде — поправка к нему в шапке спеки.
> **Что это:** план из пяти заданий, закрывающий четыре открытые находки.
> **Связанные записи:** `2026-08-13[3]-closing-findings-design.md`.
