...
> **Состояние на 2026-08-16:** выполнен и влит в `main` мержем `5af798b`;
> оговорка верификации по L7/L8 закрыта волной `56c8244`. Переименования
> доков в тексте — та самая волна, что ввела схему `YYYY-MM-DD[N]`; в прозе
> старые пути: записи живут в `docs/records/`, `TODO.md` стал
> `docs/backlog.md`.
> **Что это:** план имплементации хвоста ревью по дизайну `2026-08-05[3]`.
> **Связанные записи:** `2026-08-05[3]-review-tail-design.md`,
