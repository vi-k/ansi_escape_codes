...
> **Состояние на 2026-08-16:** исполнен и влит в `main` мержем `0f0080b`.
> Текст — вторая редакция: первая просила поле со сбросом, и её переписали
> целиком под производный геттер ещё до начала реализации.
> **Что это:** план реализации прогретого обхода, отвечающего как свежий.
> **Связанные записи:** `2026-08-13[1]-warm-walk-seam-design.md`.
