...
> **Состояние на 2026-08-16:** выполнен и влит в `main` мержем `6acae3a`;
> закрыл остаток мелочей плана ревью `2026-08-04[1]`, больше к нему не
> возвращались.
> **Что это:** дизайн и план одним документом на мелкие хвосты ревью.
