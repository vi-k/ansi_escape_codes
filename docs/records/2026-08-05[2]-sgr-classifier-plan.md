...
> **Состояние на 2026-08-16:** выполнен и влит в `main` мержем `812836b`
> (PR #12); вердикт верификации по пункту #3 — в отчёте `2026-08-05[9]`.
> В прозе старые пути: записи живут в `docs/records/`.
> **Что это:** план имплементации унификации SGR-классификатора по дизайну
> `2026-08-05[1]`.
> **Связанные записи:** `2026-08-05[1]-sgr-classifier-design.md`,
