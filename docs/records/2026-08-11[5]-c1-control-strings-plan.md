...
> **Состояние на 2026-08-16:** исполнен и влит в `main` мержем `ca5796a`.
> Читать как намерение, а не как описание поведения: номера строк даны по
> базе `e697231` и поехали после первого же задания, а **шесть ожиданий
> текста оказались неверны** — четыре из восьми в задании 2, «область
> действия живёт в одном месте» в задании 3, описание до-фиксового
> регресса в задании 4, «правка таблицы Кто чем владеет» в задании 5,
> «страховка откроется при любом расширении паттерна» в финальной волне;
> все шесть поймали исполнители, снимавшие ожидания пробником, и ни один
> не подогнал тест под код. Дефект шва вставки, найденный ревью этой
> волны, закрыт волной `2026-08-12[3]`/`[4]` (мерж `41068fd`).
> **Что это:** план реализации разбора пяти управляющих строк; спека
> старше плана, при расхождении права спека.
> **Связанные записи:** `2026-08-11[4]-c1-control-strings-design.md`,
