...
>   @ `e697231`
> - **Статус:** исполнен, влит в `main` мержем `ca5796a`
...
> - **Чему не верить:** номера строк даны по базе и поехали после
>   первого же задания. И, важнее: **ожидания в тексте плана шесть раз
>   оказались неверны** — четыре из восьми в задании 2 (срез и
>   принтеры), «область действия живёт в одном месте» в задании 3,
>   описание до-фиксового регресса в задании 4, «правка таблицы Кто чем
>   владеет» в задании 5, «страховка откроется при любом расширении
>   паттерна» в финальной волне. Все шесть поймали исполнители,
>   снимавшие ожидания пробником, и ни один не подогнал тест под код.
