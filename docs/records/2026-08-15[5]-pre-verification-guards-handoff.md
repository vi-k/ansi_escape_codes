...
> **Состояние документа**
>
> - **Тип:** handoff предыдущей волны
> - **Статус:** архивирован 2026-08-15 перед планированием M6, M7, M8 и
>   M13/L12
> - **Актуальность:** описывает полностью закрытый H8 и состояние до
>   принятой спеки `2026-08-15[4]-verification-guards-design.md`
> - **Чему не верить:** разделы «Что делать дальше», «Открыто» и шапка
>   репозитория не знают о commit `200d8ec`, выбранной новой волне и
>   обязательном просмотре владельцем её written spec
