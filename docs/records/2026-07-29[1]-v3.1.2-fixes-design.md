...
> **Состояние на 2026-08-16:** отработана — к ревью 2026-08-04 все P0–P2
> были уже починены (волна PR #1–#9, `920e506`…`d22ba9a`) по дороге к
> неопубликованной 4.0.0, а сам документ был `SPEC.md` в корне и уехал в
> `docs/` реорганизацией `9836c89` как архив. Что из спеки держится в
> коде, проверялось уже без неё — ревью `2026-08-04[1]` и верификация
> `2026-08-05[9]`; пути в прозе старые (`TODO.md` — нынешний
> `docs/backlog.md`). Запись переименована 2026-08-16, раньше называлась
> `2026-07-29[1]-fix-spec-v3.1.2.md`.
> **Что это:** спека правок по полному ревью кода v3.1.2 — находки P0–P4
> с фиксом и регрессионным тестом на каждую.
