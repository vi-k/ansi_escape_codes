...
> **Состояние на 2026-08-16:** выполнен и влит в `main` мержем `8ece39c`
> (PR #10). Числа бенчмарков в тексте — той ревизии; полоса гарда памяти
> с тех пор перемерена на двух машинах (`80b68b2`), актуальная — в
> `docs/handoff.md`. Итог по M5 и M7 поправлен отчётом `2026-08-05[9]`,
> хвост добрала волна `56c8244`.
> **Что это:** план имплементации перформанс-фиксов по дизайну
> `2026-08-04[2]`.
> **Связанные записи:** `2026-08-04[1]-pre-4.0.0-project-review.md`,
> `2026-08-04[2]-perf-fixes-design.md`,
