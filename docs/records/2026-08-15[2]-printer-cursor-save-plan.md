...
> **Состояние документа**
>
> - **Тип:** план по принятой спеке `2026-08-15[1]`
> - **Статус:** готов к исполнению, реализация не начата
> - **Актуальность:** написан против `main` @ `3787952`; base содержит принятую
>   спеку `d34b58a` и handoff перед планированием `3787952`
> - **Чему не верить:** результаты тестов, полных ворот и CI здесь ожидаемые;
>   новый handoff записывает только фактически снятые результаты. Исходные
>   симптомы и цельнострочные oracle уже сняты живыми пробниками 2026-08-15 и
>   записаны в `docs/handoff.md`; повторно выводить ожидания рассуждением нельзя.
