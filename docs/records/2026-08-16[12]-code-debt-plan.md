> **Состояние на 2026-08-17:** выполнен целиком, смержен в `main` коммитом
> `16da052`. Одно расхождение с текстом ниже: тест задания 1 сравнивает
> цвета, типизированные как `Color`, — прямое `Color16.red == Color256.red`
> аналитик красит как `unrelated_type_equality_checks`, и он прав.
